...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lazy_table-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14151&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lazy_table-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lazy_table` can be installed with:

```
conda install lazy_table
```

It is possible to list all of the versions of `lazy_table` available on your platform with:
